// A small, hand-picked line-icon set (stroke-based, 1.5px) so the app
// doesn't pull in a whole icon library for a dozen glyphs.
...
export function IconPaperclip({ size = 16, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" className={className} {...base}>
      <path d="M21 12.5l-8.5 8.5a4.5 4.5 0 01-6.4-6.4L14.8 6a3 3 0 014.2 4.2L10.5 18.7a1.5 1.5 0 01-2.1-2.1L16 9" />
    </svg>
  );
}
...
export function IconWrench({ size = 16, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" className={className} {...base}>
      <path d="M14.7 6.3a4 4 0 00-5.6 5l-7 7 2.6 2.6 7-7a4 4 0 005-5.6l-2.7 2.7-2-2z" />
    </svg>
  );
}
...
export function IconSquare({ size = 16, className }: IconProps) {
  return (
